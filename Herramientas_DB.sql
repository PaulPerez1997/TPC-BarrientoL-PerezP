...
values('1','Martillo mecanico','7','3','Martillo con cabeza de acero y mango de fibra de vidrio','750.00','0.3','30','https://http2.mlstatic.com/D_NQ_NP_658751-MLA45542364341_042021-O.webp','100','1')
go
insert [dbo].[Articulo] ([id],[nombre],[idMarca],[idCategoria],[descripcion],[precio],[peso_kg],[largo_cm],[imagenURL],[stock],[Estado]) 
values('2','Serrucho','1','4','Serrucho costilla mango anatómico profesional dientes doble filo, 10 dientes por pulgada','1110.00','0.35','30','https://http2.mlstatic.com/D_NQ_NP_669985-MLA45874217541_052021-O.webp','50','1')
go
insert [dbo].[Articulo] ([id],[nombre],[idMarca],[idCategoria],[descripcion],[precio],[peso_kg],[largo_cm],[imagenURL],[stock],[Estado])
values('3','Pinza Universal','1','3','Pinza universal Bremen 6 pulgadas de acero','1040.00','0.2','15','https://http2.mlstatic.com/D_NQ_NP_905397-MLA46115630491_052021-O.webp','25','1')
go
insert [dbo].[Articulo] ([id],[nombre],[idMarca],[idCategoria],[descripcion],[precio],[peso_kg],[largo_cm],[imagenURL],[stock],[Estado])
...
go
insert [dbo].[Articulo] ([id],[nombre],[idMarca],[idCategoria],[descripcion],[precio],[peso_kg],[largo_cm],[imagenURL],[stock],[Estado])
values('5','Amoladora angular Bosch','4','8','Amoladora angular Bosch professional GWS 670 azul 670 W 220 V, apta para un disco de 115 mm de diámetro, tiene mango anti vibración','8151.00','1.5',null,'https://http2.mlstatic.com/D_NQ_NP_745215-MLA47660403251_092021-O.webp','228','1')
go
insert [dbo].[Articulo] ([id],[nombre],[idMarca],[idCategoria],[descripcion],[precio],[peso_kg],[largo_cm],[imagenURL],[stock],[Estado])
values('6','Motosierra a nafta','8','9','Motosierra a nafta Daewoo,Cilindrada: 45cc, Largo de barra: 16", Capacidad del tanque de 550ml, Incluye accesorios.','15499.00','5.9',null,'https://http2.mlstatic.com/D_NQ_NP_887080-MLA43138730558_082020-O.webp','7','1')
go
