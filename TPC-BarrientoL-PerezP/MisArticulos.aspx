<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPeassy.Master" AutoEventWireup="true" CodeBehind="MisArticulos.aspx.cs" Inherits="TPC_BarrientoL_PerezP.MisArticulos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div id="grilla">
    <% foreach (var Art in MisArt)  
    { %>
    ...
    <a href="MisArticulos.aspx?id=<%: Art.ID %>" class="btn btn-light btn-outline-danger">Quitar</a>
