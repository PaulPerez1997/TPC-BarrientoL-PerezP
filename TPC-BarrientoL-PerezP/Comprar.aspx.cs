...
namespace TPC_BarrientoL_PerezP
{
    public partial class Comprar : System.Web.UI.Page
    {
        ...
        protected void BtnComprar_Click(object sender, EventArgs e)
        {
            ...
            {
                ArticuloDatos stockdatos = new ArticuloDatos();
                int stock = (int)ArticuloEnVenta.Stock;
                int nuevostock = stock - cantidad;

                if ( cantidad == ArticuloEnVenta.Stock)
                {
                    stockdatos.ActualizarStock(ArticuloEnVenta.ID, nuevostock);
                    stockdatos.Eliminar(ArticuloEnVenta.ID);
